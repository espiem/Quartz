...
| **Bow** | If the target of the critical hit is adjacent to a surface, it gets stuck to that surface by the missile. The target is [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Immobilized]] and must spend an [[Interact]] action to attempt a @Check\[type:athletics\|dc:10\] check to pull the missile free; it can't move from its space until it succeeds. The creature doesn't become stuck if it is incorporeal, is liquid (like a water elemental or some oozes), or could otherwise escape without effort. |
...
| **Flail** | The target is knocked [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Prone]]. |
| **Hammer** | The target is knocked [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Prone]]. |
...
| **Sword** | The target is made off-balance by your attack, becoming [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Off-Guard]] until the start of your next turn. |
