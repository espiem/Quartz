...
* * *
You can apply natural cures to heal your allies. You can use Nature instead of Medicine to [[Actions/Treat Wounds|Treat Wounds]], including higher Nature proficiency letting you attempt more difficult checks. It doesn't replace Medicine for uses of the skill other than Treat Wounds or for feat prerequisites.
