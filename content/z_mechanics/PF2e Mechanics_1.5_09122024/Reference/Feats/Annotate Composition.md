...
tags:
  ...
  - category/class
  - remaster
aliases: "Item.GRVhaCMWTk8OIw1V"
license: ORC
---
# Annotate Composition
## Feat 10
### [[z_mechanics/PF2e Mechanics_1.5_09122024/PF2e Journals/Classes/Bard]][[exploration]][[linguistic]]
...
If you have [[Spells/Fortissimo Composition|Fortissimo Composition]] or[[Spells/Lingering Composition|Lingering Composition]], you can also use one of those spells to modify the annotated composition, provided the annotated composition can benefit from the modification. The GM rolls the secret Performance check. If you do, you spend an additional Focus Point, even if the secret check fails.
