...
**Critical Success** The creature can't use reactions, is [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Off-Guard|Off-Guard]], and takes a -2 circumstance penalty to Reflex saves. These effects last until the start of its next turn.
