...
abilities_top:
  - name: ""
  - name: "Cast"
    desc: "1 hour; **Cost** sesame paste, sugar, rice balls, food dye, cooking pots, and utensils with a total value of 2 gp × the spell rank × the settlement's level; **Secondary Casters** 3"
  - name: "Primary Check"
    desc: "Cooking Lore (expert); **Secondary Checks** Diplomacy, Performance, or Religion"
