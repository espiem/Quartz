...
abilities_top:
  - name: ""
  - name: "Cast"
    desc: "1 day; **Cost** a precious possession or drop of blood from the creature to be duplicated, plus an ornate silver mirror worth 7,000 gp; **Secondary Casters** 4"
  - name: "Primary Check"
    desc: "Arcana or Occultism (master, the check has the secret trait); **Secondary Checks** Crafting, Deception, Performance, Society"
