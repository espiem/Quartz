...
abilities_top:
  - name: ""
  - name: "Cast"
    desc: "1 hour; **Cost** one gem worth a total value of the target's level (minimum 1) × 5 gp, for each target; **Secondary Casters** 2"
  - name: "Primary Check"
    desc: "Arcana or Occultism (master); **Secondary Checks** Arcana or Occultism (whichever isn&#x27;t used for the primary check), Survival"
  - name: "Range"
