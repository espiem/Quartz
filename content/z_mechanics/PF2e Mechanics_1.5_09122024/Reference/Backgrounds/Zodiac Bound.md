...
You're trained in Astrology Lore. You also gain the ability to cast a divine innate spell, as determined by your sign. The frequency with which you can cast this spell is listed below; cantrips can be used as often as you wish. As normal, you cast non-cantrip innate spells at the lowest rank available to that spell, such as 2nd rank for _water breathing_, and cantrips are heightened to half your level. Additionally, once during the prominent time for your sign (typically once per year), you can cast your sign's spell without expending its normal use.

**The Underworld Dragon (Intelligence)**: [[Spells/Ignition|Ignition]]; at will

**The Swordswoman (Dexterity)**: [[Spells/Gale Blast|Gale Blast]]; at will

**The Sea Dragon (Constitution)**: [[Spells/Water Breathing|Water Breathing]]; once per week

**The Swallow (Dexterity)**: [[Spells/Jump|Jump]]; once per day

**The Ox (Strength)**: [[Spells/Ant Haul|Ant Haul]]; once per day

**The Sovereign Dragon (Charisma)**: [[Spells/Command|Command]]; once per day

**The Ogre (Strength)**: [[Spells/Fear|Fear]]; once per day

**The Forest Dragon (Wisdom)**: [[Spells/Tangle Vine|Tangle Vine]]; at will

**The Blossom (Charisma)**: [[Spells/Dizzying Colors|Dizzying Colors]]; once per day

**The Dog (Constitution)**: [[Spells/Clear Mind|Clear Mind]]; once per week

**The Sky Dragon (Intelligence)**: [[Spells/Bless|Bless]]; once per day

**The Archer (Dexterity)**: [[Spells/Sure Strike|Sure Strike]]; once per day
