...
| Wood Gate Junction |
| --- |
| **Critical Blast** If the target of the critical hit is adjacent to a surface, roots entangle it. The target is [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Immobilized\|Immobilized]] and must spend an Interact action to attempt a DC 10 Athletics check check to pull itself free. The target doesn't become stuck if it is incorporeal, is liquid, or could otherwise escape without effort |
