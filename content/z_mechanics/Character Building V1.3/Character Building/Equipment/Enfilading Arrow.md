...
If a creature critically fails the save and you have access to the bow critical specialization effect, the target is [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Immobilized]] and must spend an Interact action to attempt a DC 10 athletics check to pull the missile free; it can't move from its space until it succeeds.
