...
**Effect** You recall a fragment of the shadow magic that suffuses your target and wrap it around yourself like a caul. The triggering creature's saving throw result is a failure, not a critical failure. For the next minute, you become [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Concealed]] to all creatures and you are [[z_mechanics/PF2e Mechanics_1.5_09122024/Rule References/Hidden]] from the triggering creature, regardless of what precise sense it has. If you use a hostile action against the triggering creature, you become only concealed to it (rather than hidden) at the end of the hostile action.
