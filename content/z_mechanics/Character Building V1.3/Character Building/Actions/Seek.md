...
The GM attempts a single secret Perception check for you and compares the result to the Stealth DCs of any [[z_mechanics/PF2e Mechanics_1.5_09122024/Rule References/Undetected]] or [[z_mechanics/PF2e Mechanics_1.5_09122024/Rule References/Hidden]] creatures in the area, or the DC to detect each object in the area (as determined by the GM or by someone [[Conceal an Object|Concealing the Object]]). A creature you detect might remain hidden, rather than becoming [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Observed]], if you're using an imprecise sense or if an effect (such as _[[Invisibility]]_) prevents the subject from being observed.
