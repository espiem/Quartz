...
**Success** The creature is [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Deafened]] and [[Clumsy 1]] until the end of its next turn, after which it's temporarily immune for 1 hour.
...
A creature [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Deafened]] by this spell can attempt to end the condition by popping its ears. It can use a single action to attempt a new Fortitude save, losing the deafened condition from this spell on a success. Some creatures with anatomies that lack inner ears or joints might be immune to these effects, as determined by the GM.
