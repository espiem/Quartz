...
**Depart** (abjuration) _Archmage's Rebuke_ The archmage drains the magic from your foes. Each of your enemies within 100 feet of the archmage must attempt a Will save. On a failure, the creature is [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Stupefied|Stupefied 2]] for 1 round, and if it's currently benefiting from any spells of a lower level than _summon archmage_, the archmage can choose any one of them and end the spell.
