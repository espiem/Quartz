...
# Déjà Vu
![[z_mechanics/Character Building V1.3/Character Building/Spells/zz_asset-files/systems-pf2e-icons-spells-deja-vu.webp|150]]
...
If the target can't repeat an action, such as [[Cast a Spell|Casting a Spell]] that has been exhausted or needing to target a creature that has died, it can act as it chooses for that action but becomes [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Stupefied|Stupefied 1]] until the end of its turn.
