...
# Elemental Gift
![[z_mechanics/Character Building V1.3/Character Building/Spells/zz_asset-files/systems-pf2e-icons-spells-elemental-gift.webp|150]]
...
*   **Earth** While on the ground, the target gets a +2 status bonus to Fortitude and Reflex saves against effects that would [[Shove]] or [[Trip]] it, and to saves against effects that would attempt to knock it [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Prone]]. In addition, the ground adjacent to the target is difficult terrain, and the difficult terrain moves with the target, though the target ignores this difficult terrain with its own movement.
