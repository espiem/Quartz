...
Regardless of whether the creature came back to life or was already alive, it regains 8d8 Hit Points, and the bolt wakes it up if it was [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Unconscious]]. For the duration of the spell, the target is supercharged. It becomes [[z_mechanics/PF2e Mechanics_1.5_09122024/Effects/Conditions/Quickened]] and can use the extra action to Stand, Stride, Strike, or Fly (if it has a fly Speed). In addition, it can cast 5th-rank [[Thunderstrike]] as an innate spell at will, using your spell DC.

The cloud that covered the creature remains until the end of the target's next turn. Any creature in the cloud is [[z_mechanics/PF2e Mechanics_1.5_09122024/Rule References/Hidden]], and anything outside the cloud is hidden to any creature inside the cloud.
